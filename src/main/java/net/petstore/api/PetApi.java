...
public interface PetApi {
    ...
    ResponseEntity<Void> deletePet(@ApiParam(value = "Pet id to delete",required=true, example = "123") @PathVariable("petId") Long petId,@ApiParam(value = "Api Key") @RequestHeader(value="api_key", required=false) String apiKey);
    ...
    @RequestMapping(value = "/pet/{petId}",
        produces = { "application/json", "application/xml" }, 
        method = RequestMethod.GET)
    ResponseEntity<Pet> getPetById(@ApiParam(value = "ID of pet to return",required=true, example = "123") @PathVariable("petId") Long petId);
    ...
    @RequestMapping(value = "/pet/{petId}",
        ...
        method = RequestMethod.POST)
    ResponseEntity<Void> updatePetWithForm(@ApiParam(value = "ID of pet that needs to be updated",required=true, example = "123") @PathVariable("petId") Long petId,
    ...
    @RequestMapping(value = "/pet/{petId}/uploadImage",
        ...
        method = RequestMethod.POST)
    ResponseEntity<ModelApiResponse> uploadFile(@ApiParam(value = "ID of pet to update",required=true, example = "123") @PathVariable("petId") Long petId,
