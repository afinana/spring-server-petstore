...
public class StoreApiController implements StoreApi {
    ...
    public ResponseEntity<Void> deleteOrder(@Min(1L)@ApiParam(value = "ID of the order that needs to be deleted",required=true, example = "123") @PathVariable("orderId") Long orderId) {
    ...
    public ResponseEntity<List<MapInventory>> getInventory() {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<MapInventory>>(objectMapper.readValue("{}", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
        ...
        if (accept != null && accept.contains("application/xml")) {
            try {
                return new ResponseEntity<List<MapInventory>>(objectMapper.readValue("<PetInventory>  <name>aeiou</name>  <value>123456789</value></PetInventory>", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<Order> getOrderById(@Min(1L) @Max(10L) @ApiParam(value = "ID of pet that needs to be fetched",required=true, example = "123") @PathVariable("orderId") Long orderId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
